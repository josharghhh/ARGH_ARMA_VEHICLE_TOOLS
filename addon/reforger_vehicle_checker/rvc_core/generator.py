...
def _base_prefab(project: VehicleProject) -> str:
    ...
    components.append(
        ...
        f'    SCR_WheelSlotInfo Wheel_L01 {{ Prefab "{wheel}" }}\n'
        f'    SCR_WheelSlotInfo Wheel_L02 {{ Prefab "{wheel}" }}\n'
        f'    SCR_WheelSlotInfo Wheel_R01 {{ Prefab "{wheel}" }}\n'
        f'    SCR_WheelSlotInfo Wheel_R02 {{ Prefab "{wheel}" }}\n'
